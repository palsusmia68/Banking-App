...
public class MyAccountSummaryAdapter extends RecyclerView.Adapter<MyAccountSummaryAdapter.ViewHolder> {
    private ArrayList<WCAccountSummaryClass> summaryClassArrayList;
    Context context;

    public MyAccountSummaryAdapter(ArrayList<WCAccountSummaryClass> summaryClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_account_statement, parent, false);
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            item_ac_no = itemView.findViewById(R.id.item_tv_acNo);
