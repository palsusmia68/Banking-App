...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        ImageView camera_img = dialog.findViewById(R.id.cameraImage);
        ImageView gallery_img = dialog.findViewById(R.id.galleryImage);
        ImageView img_remove = dialog.findViewById(R.id.img_remove);
